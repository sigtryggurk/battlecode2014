...
public class RobotPlayer
{
    ...
    private static void runSoldier() throws GameActionException
    {
        ...
        MapLocation averagePositionOfSwarm = mldivide(intToLoc(rc.readBroadcast(usingChannel + 2)),
                rc.readBroadcast(usingChannel));

        rc.setIndicatorString(0, "" + locToInt(averagePositionOfSwarm));

        // movement
        // Direction chosenDirection =
        // allDirections[(int)(randall.nextDouble()*8)];
